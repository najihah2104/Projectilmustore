...
public class LoginActivity extends AppCompatActivity {
        ...
        class LoginUser extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = rh.sendPostRequest
                        ("https://projectilmustore.000webhostapp.com/member/login.php",hashMap);
                return s;
            }
    ...
    void forgotPasswordDialog(){
        ...
        final EditText edemail = dialogforgotpass.findViewById(R.id.edt_Email);
        Button btnsendemail = dialogforgotpass.findViewById(R.id.btn_reset);
    ...
    private void sendPassword(final String forgotemail) {
        class SendPassword extends AsyncTask<Void,String,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                RequestHandler rh = new RequestHandler();
                String s = rh.sendPostRequest("https://projectilmustore.000webhostapp.com/member/verify_email.php",hashMap);
                return s;
            }
            @Override
            protected void onPostExecute(String s) {
