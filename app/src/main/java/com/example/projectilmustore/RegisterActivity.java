...
public class RegisterActivity extends AppCompatActivity {
        ...
        class RegisterUser extends AsyncTask<Void,Void,String>{
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = rh.sendPostRequest
                        ("https://projectilmustore.000webhostapp.com/member/insert_registration.php",hashMap);
                return s;
            }
    ...
    private void initView() {
        ...
        edPass = findViewById(R.id.txt_password);
        edPhone =findViewById(R.id.txt_phone);
        edName = findViewById(R.id.txt_name);
        btnReg = findViewById(R.id.btn_register);
        tvlogin = findViewById(R.id.tvlogin);
        imgprofile = findViewById(R.id.cam);
        tvlocation = findViewById(R.id.text_Loc);
        ...
        private void makeRequest(final String encoded_string, final String image_name) {
            class UploadAll extends AsyncTask<Void, Void, String> {
                ...
                protected String doInBackground(Void... params) {
                    ...
                    RequestHandler rh = new RequestHandler();
                    String s = rh.sendPostRequest("https://projectilmustore.000webhostapp.com/member/insert_registration.php", hashMap);
                    return s;
                }
