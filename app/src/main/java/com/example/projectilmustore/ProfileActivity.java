...
public class ProfileActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvuserid = findViewById(R.id.txt_email);
        tvname = findViewById(R.id.txt_Username);
        tvphone = findViewById(R.id.txt_phone);
        edoldpass = findViewById(R.id.txt_old_password);
        ednewpass = findViewById(R.id.txt_new_password);
        ...
        String image_url = "https://projectilmustore.000webhostapp.com/member/profileimages/" + phone + ".jpg";
    ...
    void loadUserProfile() {
        class LoadUserProfile extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String s = rh.sendPostRequest("https://projectilmustore.000webhostapp.com/member/load_user.php", hashMap);
                return s;
            }
            ...
            protected void onPostExecute(String s) {
                ...
                try {
                    ...
                    JSONArray shoparray = jsonObject.getJSONArray("user");
                    JSONObject c = shoparray.getJSONObject(0);
    ...
    void updateProfile(final String newemail, final String newname, final String newloc, final String oldpass, final String newpass) {
        class UpdateProfile extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                ...
                RequestHandler rh = new RequestHandler();
                String s = rh.sendPostRequest("https://projectilmustore.000webhostapp.com/member/update_profile.php", hashMap);
                return s;
            }
    ...
    private void loadMapWindow() {
        ...
        Button btnsavemap = myDialogMap.findViewById(R.id.btn_save_loc);
